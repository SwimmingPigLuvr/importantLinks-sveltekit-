  ...
  theme: {
    extend: {
      fontFamily: {
        ...
        'change': ['change', 'serif'],
        'change-italic': ['change-italic', 'serif'],
        'change-medium': ['change-medium', 'serif'],
        'change-medium-italic': ['change-medium-italic', 'serif'],
        'change-semibold': ['change-semibold', 'serif'],
        'change-semibold-italic': ['change-semibold-italic', 'serif'],
        'change-bold': ['change-bold', 'serif'],
        'change-bold-italic': ['change-bold-italic', 'serif'],
      },
    },
  },
  daisyui: {
